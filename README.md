...
1) Clone the repo
    ```sh
    git clone https://github.com/JasbirCodeSpace/Decentralized-Document-Verification.git
    ```
...
4) Specify environment variables in .env file.
    ...
    5) Sample .env file
        ...
        CCP_PATH = /home/jasbir/fabric-samples/test-network/organizations/peerOrganizations/org1.example.com/connection-org1.json
